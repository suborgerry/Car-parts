...
class ControllerExtensionModuleAbandonedCarts extends Controller {
  ...
  public function install() {
	...
	public function index() {
		...
		$data['module_abandoned_statuses'] = $this->model_localisation_order_status->getOrderStatuses();
	...
	protected function validate() {
		...
		if ($this->request->post['module_abandoned_carts_limit'] < 1) {
			$this->error['module_abandoned_carts_limit'] = $this->language->get('error_limit');
		}
