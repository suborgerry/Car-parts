...
table.secondary td{background:#e9e9e9;border-color:#d0d0d0;color:#555;}table.secondary td a{color:#555;}table.secondary:hover td{background:#d0d0d0!important;color:#555;}table.secondary:hover td a,table.secondary td a:visited,table.secondary:active td a{color:#555!important;}table.success td{background:#5da423;border-color:#457a1a;}table.success:hover td{background:#457a1a!important;}table.alert td{background:#c60f13;border-color:#970b0e;}table.alert:hover td{background:#970b0e!important;}body.outlook p{display:inline!important;}@media only screen and (max-width: <?php echo ($width_unit == 'px') ? ($width+20).$width_unit : $width.$width_unit; ?>) {table[class="body"] img{width:auto!important;height:auto!important;}
...
.header{color:<?php echo $color['text_head']; ?>; background-color:<?php echo $color['bg_header']; ?>; <?php echo $theme['bg_header'] ? 'background-image:url('.$img_path.$theme['bg_header'].') '.$theme['bg_header_repeat'].';' : ''; ?>; padding:40px 0; text-align:center;}
.header a img{color:<?php echo $color['text_head']; ?>; font-size:30px;}
.header a{color:<?php echo $color['link_head']; ?>;}
.button{display:inline-block;width:auto!important;text-align:center;background-color:<?php echo $color['btn']; ?>;color:<?php echo $color['btn_text']; ?>;padding:8px 30px;}
