...
@media only screen and (max-width: 400px){.hide_mobile{display:none}.show_mobile{display:block}.show_mobile_td{display:table-cell!important}}</style>
<style>
...
.main{background-color:<?php echo $color['bg_body']; ?>; <?php echo $theme['bg_body'] ? 'background-image:url('.$img_path.$theme['bg_body'].') '.$theme['bg_body_repeat'].';' : ''; ?>;}
.header{color:<?php echo $color['text_head']; ?>; background-color:<?php echo $color['bg_header']; ?>; <?php echo $theme['bg_header'] ? 'background-image:url('.$img_path.$theme['bg_header'].') '.$theme['bg_header_repeat'].';' : ''; ?>; padding:20px 0; text-align:center;}
.header a img{color:<?php echo $color['text_head']; ?>; font-size:30px;}
.header a{color:<?php echo $color['link_head']; ?>;}
.button{display:inline-block;width:auto!important;text-align:center;background-color:<?php echo $color['btn']; ?>;color:<?php echo $color['btn_text']; ?>;padding:8px 30px;-webkit-border-radius:3px; -moz-border-radius:3px; border-radius:3px;}
a{color:<?php echo $color['link']; ?>;}
span.content{display:block; font-size:12px; padding:10px 15px;-moz-hyphens:none;-webkit-hyphens:none;hyphens:none;}
.footer p{margin-bottom:0;}
.footer{display:block; font-size:12px; padding:10px 15px;
  ...
  <tr>
    <td class="page center" align="center" valign="top">
      <center>
        ...
        <table class="responsive-table <?php echo $direction; ?>" <?php echo $theme['bg_body'] ? 'background="'.$img_path.$theme['bg_body'].'"' : ''; ?>>
        <?php if (!empty($top)) { ?>
        <tr>
          <td class="center top" align="center" valign="top">
            <center>
              <table class="container top"><tr><td>
                <span>
                <?php echo $top; ?>
                </span>
              </td></tr></table>
        ...
        <tr>
          <td class="center main" align="center" valign="top">
            <center>
        ...
        <?php if (!empty($bottom)) { ?>
        <tr>
          <td class="center bottom" align="center" valign="top">
            <center>
              <table class="container bottom"><tr><td>
                <span>
                <?php echo $bottom; ?>
                </span>
              </td></tr></table>
