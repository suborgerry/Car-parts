...
class ControllerExtensionQuickCheckoutCheckout extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $theme . '/stylesheet/quickcheckout.css')) {
			...
			$this->document->addStyle('catalog/view/theme/default/stylesheet/quickcheckout.css?v=2.2');
		}
		...
		} elseif (isset($data['error_warning_minimum'])&&$data['error_warning_minimum']!='') {
