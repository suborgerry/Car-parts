...
<div class="CmWrapFlexBlock">
    ...
    <div class="CmFiltersMainP">
        ...
        <div class="main_part" style="<? if (!$aRes['HAVE_FILTERS']) {
            echo 'width:100%';
        } ?>">
                ...
                <div class="CmSortFilterBlock">
                    <div class="sort_but">
                        <div class="butt_sel" data-loadview="<?= $aRes['ACTIVE_TAB'] ?>">
                            ...
                            } ?>" data-view="LIST" data-urix="<?= PROTOCOL_DOMAIN_x ?><?= $_SERVER['REQUEST_URI'] ?>">
                            ...
                            <div style="display: none" class="e viewtable_cm cm_viewAct <? if ($aRes['ACTIVE_TAB'] == 'TABLE') {
                                echo 'CmColorTxi cm_viewShad CmColorFi';
