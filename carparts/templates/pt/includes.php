...
<script>
    ...
    jQuery(document).ready(function($) {
        var CmsCartID = '<? if (defined('CmsCartID')) {
                                echo CmsCartID;
                            } ?>';
        var IsCmAdmin = '<? if (IsADMIN_x) {
                                echo 'Y';
                            } ?>';
        console.log('test pt');
        ...
        $("body").on("click", ".CmAddToCart", function(e) {
            e.stopPropagation();
            this.parentElement.classList.add('color-blue');
...
<style>
    ...
    .CmColorTxD {
        text-decoration-color: #<?= COLOR_MAIN ?> !important;
    }

    /* Background */
    .CmColorBg {
        background-color: var(--color_product_button_bg) !important;
    }
    ...
    .CmColorBgA {
        background-color: #<?= COLOR_MAIN ?>1f !important;
    }
    ...
    .CmColorOu {
        outline-color: #<?= COLOR_MAIN ?> !important;
    }
    ...
    /* Shadow */
    .CmColorSh {
        --box-shadow-color: #<?= COLOR_MAIN ?> !important;
    }
</style>
<?
...
?><ul class="CmBreadCrumbs" typeof="BreadcrumbList"><?
                                                        if (is_array($aCmBCrumbs) and count($aCmBCrumbs) > 1) {
                                                            ...
                                                            $pos = 0;
                                                            foreach ($aCmBCrumbs as $Crumb => $Link) {
                                                                $pos++;
                    ...
                    <svg class="CmBrCrArrow" viewBox="0 0 24 24">
