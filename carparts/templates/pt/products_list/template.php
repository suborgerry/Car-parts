...
<div class="CmTopBox s" style="display: none">
...
if (!isset($aRes['HIDE_HEADBOX'])) { ?> <!--Makes: <div id="CmAjaxBox">  -->
    <div class="CmBrTitleSearchWrap CmColorBgL CmColorBr" style="display:none">
        <div id="CmTitlH1Page">
            <h1 class="CmColorTx"><?= H1_x ?></h1>
        </div>
    </div>
<? } ?>
<?
...
<div class="CmWrapFlexBlock">
    ...
    <div class="CmFiltersMainP">
        <? if ($aRes['HAVE_FILTERS']) { ?>
            <div class="left_fil <? if ($aRes['ACTIVE_TAB'] == 'LIST') {
                                        echo 'CmColorBr CmLeftFilBor';
                                    } ?>">
                ...
                <div class="CmWrapLpartBlock">
                    <? if ($aRes['FILTER_PRODUCTS']) { ?>
                        <div class="l_part sidebarBlock">
                            <div class="l_part sidebarBlock-heading"><?= Lng_x('Product_type', 1) ?></div>
                            <!-- <hr class="titleSet CmColorBr"> -->
                            <div class="sidebarBlock-content">
                                <ul class="all-categories-list">
                                    <? foreach ($aRes['FILTER_PRODUCTS'] as $ProdID => $aProd) { ?>
                                        <li class="navPages-item navPages-level-1 _0NOHWa CmFilterCheck <? if ($aProd['Checked']) { ?>CmColorTxi TxBold<? } ?>" data-prid="<?= $ProdID ?>">
                                            <div class="check_b">
                                                <? if ($aProd['Checked']) { ?>
                                                    <svg class="material-icon CmColorFi" viewBox="2 2 24 24">
                                                        <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
                                                    </svg>
                                                <? } ?>
                                            </div>
                                            <span class="CmFilCheckTxt" title="<?= $aProd['Info'] ?>"><?= $aProd['Name'] ?><sup>&nbsp;<?= $aRes['PRODUCTS_TYPES'][$ProdID] ?></sup> <span><?= $aProd['Info'] ?></span></span>
                                        </li>
                                    <? } ?>
                                </ul>
                            </div>
                        ...
                        <div class="l_part"><?
                                ...
                                <div class="l_filter"><?
                                                        foreach ($aCri['Values'] as $CrCode => $CrName) {
                                                            if ($aCri['Checked'] and in_array($CrCode, $aCri['Checked'])) {
                                                                $Checked = true;
                                                            } else {
                                                                $Checked = false;
                                                            } ?>
                                        <div class="CmFilterCheck <? if ($Checked) { ?>c_Txi TxBold<? } ?>" data-crcod="<?= $CrCode ?>">
                                            <div class="check_b">
                                                <? if ($Checked) { ?><svg class="material-icon fillBg" viewBox="2 2 24 24">
                                                        <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" />
                                                    </svg><? } ?>
                                            </div>
                                            <span>
                        ...
                        <div class="CmPriceRangeSl">
                            ...
                            <div class="rangePriceBlock">
                                ...
                                <div class="bigRangeTextBl" style="left:25%">
                                    <span class="bigRange"></span>
                                    <span class="bigRangeText"><? if ($aRes['MIN_PRICE'] > 0 && $aRes['MAX_PRICE'] <= 10) {
                                                                    echo $rangeFl;
                                                                } else {
                                                                    echo $rangeInt;
                                                                } ?></span>
                                ...
                                <div class="bigRangeTextBl" style="left:50%">
                                    <span class="bigRange"></span>
                                    <span class="bigRangeText"><? if ($aRes['MIN_PRICE'] < 10 && $aRes['MAX_PRICE'] == 10) {
                                                                    echo $rangeFl * 2;
                                                                } else {
                                                                    echo $rangeInt * 2;
                                                                } ?></span>
        ...
        <div class="main_part b" id="collection-page" style="<? if (!$aRes['HAVE_FILTERS']) {
                                                                    echo 'width:100%';
                                                                } ?>">
            ...
            <div class="filters-toolbar">
                <div class="CmSortFilterBlock m filters-toolbar-wrapper">
                    <div class="sort_but filters-toolbar" style="display: none;">
                                ...
                                <div class="sort_bl">
                                    ...
                                    <div class="hide_bl">
                                        ...
                                        <div class="CmSortBlockClose">
                                            <svg class="CmCloseSort" viewBox="0 0 24 24">
                ...
                <div class="filters-toolbar__item-wrapper two">
                    <div class="filters-toolbar__item-child">
                        <div class="view-as-group">
                            ...
                            <div class="butt_sel filters-toolbar__item-wrapper two" data-loadview="<?= $aRes['ACTIVE_TAB'] ?>">
                                <div class="viewlist_cm cm_viewAct <? if ($aRes['ACTIVE_TAB'] == 'LIST') {
                                                                        echo 'cm_viewShad';
                                                                    } ?>" <? if ($aRes['ACTIVE_TAB'] == 'LIST') { ?>style="fill: #000" <? } ?> data-view="LIST" data-urix="<?= PROTOCOL_DOMAIN_x ?><?= $_SERVER['REQUEST_URI'] ?>">
                                    <svg class="material-icon icon_im" viewBox="0 -4 24 24" position="50">
                                        <path d="M4 14h4v-4H4v4zm0 5h4v-4H4v4zM4 9h4V5H4v4zm5 5h12v-4H9v4zm0 5h12v-4H9v4zM9 5v4h12V5H9z" />
                                    </svg>
                                    <div class="but_text"></div>
                                </div>
                                <div class="viewgrid_cm cm_viewAct <? if ($aRes['ACTIVE_TAB'] == 'GRID') {
                                                                        echo 'CmColorTxi cm_viewShad CmColorFi';
                                                                    } ?>" data-view="GRID" data-urix="<?= PROTOCOL_DOMAIN_x ?><?= $_SERVER['REQUEST_URI'] ?>">
                                    <svg class="material-icon icon_im" viewBox="0 -4 24 24">
                                        <path d="M4 11h5V5H4v6zm0 7h5v-6H4v6zm6 0h5v-6h-5v6zm6 0h5v-6h-5v6zm-6-7h5V5h-5v6zm6-6v6h5V5h-5z" />
                                    </svg>
                                    <div class="but_text"></div>
                                </div>
                                <div class="v viewtable_cm cm_viewAct <? if ($aRes['ACTIVE_TAB'] == 'TABLE') {
                                                                            echo 'CmColorTxi cm_viewShad CmColorFi';
                                                                        } ?>" data-view="TABLE" data-urix="<?= PROTOCOL_DOMAIN_x ?><?= $_SERVER['REQUEST_URI'] ?>">
                                    <svg class="material-icon icon_im" viewBox="0 -4 24 24" position="50">
                ...
                <div class="filters-toolbar__item-wrapper three">
                    <!-- <div class="filters-toolbar__item-child" data-limited-view="">
                            ...
                            <div class="filters-toolbar__input-wrapper select-group">
                                <script><? print($arConSets) ?></script>
                                <select name="paginateBy" id="showPagination" class="filters-toolbar__input">
                                    <option value="<?= $limitLink6 ?>"> 6 items per page</option>
                                    <option value="<?= $limitLink12 ?>"> 12 items per page</option>
                                    <option value="<?= $limitLink18 ?>"> 18 items per page</option>
                                    <option value="<?= $limitLink24 ?>"> 24 items per page</option>
                                    <option value="<?= $limitLink30 ?>"> 30 items per page</option>
                                    <option value="<?= $limitLink36 ?>" selected=""> 36 items per page</option>
                                    <option value="<?= $limitLink42 ?>"> 42 items per page</option>
                                </select>
