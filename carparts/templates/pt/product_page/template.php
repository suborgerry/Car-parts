...
if ($aRes['Color']) {
    $BrandStyleColor = 'style="color:#' . $aRes['Color'] . '"';
}
...
?>
<? if (IsADMIN_x) { ?>
    <!-- <script>console.log(<?php print_r(json_encode($aProd, JSON_PRETTY_PRINT)); ?>)</script> -->
    ...
    <div class="CmHeadTitleWrapBlock">
        <div class="CmTitleBox">
            <div class="cmInnerBl">
                ...
                <!-- <div class="CmVertLineBlock" style="border-color:#<? if ($aRes['BRAND']['Color']) {
                    echo $aRes['BRAND']['Color'];
                } else {
                    echo 'cdcdcd';
                } ?>"></div> -->
...
<div class="blockMainPart">
    ...
    <div class="blockProdCard">
        ...
        <div class="CmBlockPropsPriceWrap">
                    ...
                    <div class="CmPropsInnerBlock" style="<? if ($HideProps) { ?>height:85px; overflow:hidden;<? } ?>">
                        <div class="innBlockProps">
                            <div class="ratLinkCuntr">
                                <div class="CmCountRatWrap">
                                    <div class="CmRatStarsFlagBl">
                                        ...
                                        <div class="cmCountNameFlagWrap" data-color="<?= $aRes['BRAND']['Color'] ?>">
                                            <div class="CmCoutryName" style="color:#<? if ($aRes['BRAND']['Color']) {
                                                echo $aRes['BRAND']['Color'];
                                            } else {
                                                echo 'cdcdcd';
                                            } ?>"><?= $aRes['BRAND']['CName'] ?></div>
                                        </div>
                                        <? //=StarRatingFunc($aRes['BRAND']['Rating'])?>
                                        <!-- <style>
                                            .cmRatingSt svg{fill:#<? if ($aRes['BRAND']['Color']) {
                                                echo $aRes['BRAND']['Color'];
                                            } else {
                                                echo '808080';
                                            } ?>}
                                ...
                                <div class="CmHorisLineBlock" style="border-color:#<? if ($aRes['BRAND']['Color']) {
                                    echo $aRes['BRAND']['Color'];
                                } else {
                                    echo 'cdcdcd';
                                } ?>"></div>
            ...
            <div class="CmPriceEditPrButWrap">
                ...
                <div class="blockProdPrice" data-wsact="<? if ($aRes['WsAjax']) {
                    echo '1';
                } ?>" >
    ...
    <div class="wrapBlTabsMenu" style="<? if ($_REQUEST['CarModAjaxProdPrice'] == 'Y') {
        echo 'width:100%; margin:0px auto';
    } ?>" data-cmdir="<?= CM_DIR ?>" data-request="<?= $_REQUEST['CarModAjaxProdPrice'] ?>" data-url="<?= $aRes['DETAIL_PAGE_URL'] ?>" data-avail="<? if (!$AnalogsAvail) { ?>N<? } ?>">
                ...
                <div class="centBlockInfo" style="<? if ($_REQUEST['CarModAjaxOENumbers'] === "Y") { ?>grid-template-columns:1fr;<? } else { ?>grid-template-columns:2fr 1fr 1fr;<? } ?>">
                            ...
                            <div class="CmOeBlockInside">
                                <div class="modelNumTable ">
                                    ...
                                    <table class="CmOeNumTable">
                                        <? foreach ($aRes['OE'] as $Brand => $aOENums) {
                                            $Cm = '';
                                            $s++ ?>
                    ...
                    <? if ($aRes['OLD_NUMBERS'] || $aRes['NEW_NUMBERS']) { ?>
                        <div class="blOldNewNum CmInfoInBlock">
                            <div class="cmNewOldTitleTd cmNewOldTitle CmColorTx CmColorBr" colspan="2"><? if ($aRes['OLD_NUMBERS']) {
                                echo Lng_x('Replaced_Numbers');
                            } else if ($aRes['NEW_NUMBERS']) {
                                echo Lng_x('New_Number');
                            } ?>:</div>
                            <? if ($aRes['OLD_NUMBERS']) {
